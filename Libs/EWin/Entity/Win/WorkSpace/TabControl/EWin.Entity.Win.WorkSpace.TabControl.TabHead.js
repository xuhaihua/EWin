/**
    * 本文件主要用于定义TabBox实体，该实体继承自BaseTaBox
...
( function() {
    ...
    eval( JPM.spaceUsing("EWin.Entity.Win.WorkSpace.TabControl", "Tag,TabHead,TabCloseBut") );
    eval( JPM.spaceUsing("EWin.Event", "TabHeadEvent") );
    eval( JPM.spaceUsing("EWin", "ITabHead") );
    ...
    JPM.nameSpace(
        ...
        function TabHead( tagNode ) {
            
            /*--定义属性开始--*/
            this.tagNode = tagNode;
            this.wFlex = true;                  
            this.hFlex = false;
            this.childType="Tag|TabCloseBut";
            /*--定义属性结束--*/
